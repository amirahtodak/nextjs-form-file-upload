...
const scriptWebAppUrl = "";
const gsheet = "";

export default function FormFileTemplate() {
  const {
    register,
    handleSubmit,
  ...
  useEffect(() => {
    if (acceptedFiles !== undefined) {
      setDocument(document.concat(acceptedFiles));
    }
      ...
      <form onSubmit={handleSubmit(handleSubmitForm)} className="w-full">
        <CardContent>
          <div className="grid w-full items-center gap-5">
            ...
            {/* ATTACHMENT */}
            <div {...getRootProps()}>
              <Button>Upload images here</Button>
            ...
            <div>
              <p className="text-[10px] text-muted-foreground">
                If you haven&apos;t received your email, please also check in
